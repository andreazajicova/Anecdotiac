...
class AnecdotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anecdote" do
    assert_difference('Anecdote.count') do
      post anecdotes_url, params: { anecdote: { body: @anecdote.body, title: @anecdote.title, user_id: @anecdote.user_id } }
    end
  ...
  test "should update anecdote" do
    patch anecdote_url(@anecdote), params: { anecdote: { body: @anecdote.body, title: @anecdote.title, user_id: @anecdote.user_id } }
